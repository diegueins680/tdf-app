...
| PER-17 Javier, venue representative | Claim/review status and private-vs-public field boundaries should be easy to understand; venue detail uses a web fallback on mobile. | Claim ownership API tests and web/mobile continuation required. |
