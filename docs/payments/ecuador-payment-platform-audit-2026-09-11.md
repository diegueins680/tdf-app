...
| CI | Available/read-only | Default-branch history and every check on #331/#332 were inspected. At the last pre-delivery check, #331 was green and #332 had all completed checks green while `backend-quality` was still running. No check was represented as passing unless run locally or reported successful by GitHub. |
