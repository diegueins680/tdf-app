...
| EO-024 | Complete RACI, approvers/watchers/escalation | Existing but requiring modification | Canonical RACI/policy and scoped reads now exist. PR 23 adds private single-pair reassignment with atomic audit/receipt/revision; public commands, consent, approvers/watchers/escalation remain incomplete. See [evidence](pr-23-raci-reassignment-command.md). |
