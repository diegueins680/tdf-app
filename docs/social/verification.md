...
versions, idempotent terminal delivery. Operations are atomic database transactions;
trusted handlers supply authenticated actor identity. Fair scheduling of Finish(v)
