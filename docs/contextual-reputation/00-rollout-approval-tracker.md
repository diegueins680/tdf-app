...
| Gates de activación | Activación autorizada; verificación pendiente | Flujo contextual `true` en staging/producción; worker solo staging en `simulation` | Operaciones |
