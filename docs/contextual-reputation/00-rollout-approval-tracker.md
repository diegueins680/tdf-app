...
| Gates de activación | Activación autorizada; verificación pendiente | Flujo contextual `true` en staging/producción; gate DB antes del worker de staging en `simulation` | Operaciones |
