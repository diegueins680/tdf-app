...
| Bank/cash/POS | Canonical manual attempt, customer evidence submission and protected finance review for services and marketplace sale/rental checkout | Independent authorized staff approval with exact immutable checkout/attempt/amount/currency/environment binding; browser selection and reference submission never mean payment | Compensating manual record required | No | Admin-reviewed settlement only | Marketplace sale/rental domain flags and manual methods are enabled; production deployment is still separate, and expired holds, non-zero rental-deposit refunds and every external settlement require reviewed evidence |
