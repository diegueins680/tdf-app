...
Dependency advisory baselines are not green: the root install reports 23 findings (1 critical, 17 high, 3 moderate, 2 low) and the mobile install reports 52 (2 critical, 18 high, 28 moderate, 4 low). They include transitive/tooling packages outside this navigation change and were not bulk-upgraded because that would materially expand release risk. Triage and targeted upgrades are required before a production-complete declaration.
