...
El esquema/pruebas cubren 1–5 y 10–20 a nivel de dominio/datos en distinta profundidad; UI/contrato cubren recorridos 6–9 y 14–23. La superficie pública se verificó en runtime web y Android con APIs sintéticas, y los handlers críticos de orden/cancelación/incidencias contra PostgreSQL real; los recorridos HTTP completos de vendedor/admin/pago y el runtime iOS/dispositivo físico siguen pendientes. El punto 13 está protegido en base y en la cancelación real probada. El 24 solo puede declararse parcial. El 25 se cumple manteniendo checkout, pagos y publicación pública en flags `false` y usando mensajes de piloto.
