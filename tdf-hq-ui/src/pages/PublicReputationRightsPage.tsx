...
export default function PublicReputationRightsPage({ view = 'privacy' }: { view?: ReputationRightsView }) {
  ...
  const copy = english ? {
    ...
    calculationBody: 'Version public-bayes-roc-v1 starts each category/context estimate at 50 with Bayesian strength 8, applies a 365-day half-life, caps one evaluator at 25%, and provisionally excludes disputed signals. Public results remain in progress until three verified signals; then they show low, moderate, or high confidence. The current overall score is the verified-signal-count-weighted average of category estimates. Comparable ordinal rankings use a Bayesian Bradley–Terry model with ties and are never converted directly to stars. Personal category priorities create a private compatibility score and never change another person’s public reputation.',
    ...
    calculationBody: 'La versión public-bayes-roc-v1 inicia cada estimación por categoría y contexto en 50 con fuerza bayesiana 8, aplica semivida de 365 días, limita a un evaluador al 25% y excluye provisionalmente señales disputadas. Los resultados públicos permanecen en formación hasta tres señales verificadas; después muestran confianza baja, moderada o alta. La puntuación global actual es el promedio de las estimaciones por categoría ponderado por cantidad de señales verificadas. Los rankings ordinales comparables usan un modelo Bradley–Terry bayesiano con empates y nunca se convierten directamente en estrellas. Las prioridades personales crean una puntuación privada de compatibilidad y nunca cambian la reputación pública de otra persona.',
