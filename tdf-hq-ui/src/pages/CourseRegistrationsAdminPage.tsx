...
const firstRunOfferDescriptorPrefixPattern =
  /^(?:(?:early[-\s]?bird|promo(?:tional)?|discount(?:ed)?)\s+(?:(?:course\s+)?(?:(?:pre[-\s]?)?registration|enrollment|sign[-\s]?up)(?:\s+(?:forms?|pages?|links?|urls?|portals?))?|forms?|pages?|links?|urls?|portals?)|(?:formularios?|p[aá]ginas?|enlaces?|links?|urls?|portales?)\s+de\s+(?:descuento|promoci[oó]n|oferta)|(?:descuento|promoci[oó]n|oferta)\s+de\s+(?:inscripci[oó]n|registro|matr[ií]cula))(?:\s+(?:del|de|para\s+el|para|for))?\s*(?:[-:/|]\s*)?/i;

const firstRunOfferDescriptorSuffixPattern =
  /\s*(?:[-:/|]\s*)?(?:(?:early[-\s]?bird|promo(?:tional)?|discount(?:ed)?)\s+(?:(?:course\s+)?(?:(?:pre[-\s]?)?registration|enrollment|sign[-\s]?up)(?:\s+(?:forms?|pages?|links?|urls?|portals?))?|forms?|pages?|links?|urls?|portals?)|(?:formularios?|p[aá]ginas?|enlaces?|links?|urls?|portales?)\s+de\s+(?:descuento|promoci[oó]n|oferta)|(?:descuento|promoci[oó]n|oferta)\s+de\s+(?:inscripci[oó]n|registro|matr[ií]cula))\s*$/i;
