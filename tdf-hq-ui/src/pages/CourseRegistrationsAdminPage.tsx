...
const firstRunLiveSessionDescriptorPrefixPattern =
  /^(?:(?:(?:zoom|google\s+meet|microsoft\s+teams|teams)\s+)?(?:webinar|seminar|meeting|live\s+session|sesi[oó]n\s+en\s+vivo)\s+(?:registration|enrollment|sign[-\s]?up|waitlist|booking|reservation|rsvp)(?:\s+(?:form|page|portal|link|url))?|(?:zoom|google\s+meet|microsoft\s+teams|teams)\s+(?:registration|enrollment|sign[-\s]?up|waitlist|booking|reservation|rsvp)(?:\s+(?:form|page|portal|link|url))?|(?:formulario|p[aá]gina|portal|enlace|link|url)\s+de\s+(?:registro|inscripci[oó]n|reserva|rsvp|lista\s+de\s+espera)\s+(?:de|para)\s+(?:webinar|seminario|seminar|meeting|sesi[oó]n\s+en\s+vivo))(?:\s+(?:del|de|para\s+el|para|for))?\s*(?:[-:/|]\s*)?/i;

const firstRunLiveSessionDescriptorSuffixPattern =
  /\s*(?:[-:/|]\s*)?(?:(?:(?:zoom|google\s+meet|microsoft\s+teams|teams)\s+)?(?:webinar|seminar|meeting|live\s+session|sesi[oó]n\s+en\s+vivo)\s+(?:registration|enrollment|sign[-\s]?up|waitlist|booking|reservation|rsvp)(?:\s+(?:form|page|portal|link|url))?|(?:zoom|google\s+meet|microsoft\s+teams|teams)\s+(?:registration|enrollment|sign[-\s]?up|waitlist|booking|reservation|rsvp)(?:\s+(?:form|page|portal|link|url))?|(?:formulario|p[aá]gina|portal|enlace|link|url)\s+de\s+(?:registro|inscripci[oó]n|reserva|rsvp|lista\s+de\s+espera)\s+(?:de|para)\s+(?:webinar|seminario|seminar|meeting|sesi[oó]n\s+en\s+vivo))\s*$/i;
