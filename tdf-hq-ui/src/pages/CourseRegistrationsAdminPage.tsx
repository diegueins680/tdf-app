...
const stripFirstRunCohortPresentationMarkers = (value: string) =>
  decodeFirstRunCohortHtmlEntities(value)
    ...
    .replace(
      /^\[(?:TODO|FIXME|DRAFT|BORRADOR|WIP|TEST|DEMO|SAMPLE|STAGING|SANDBOX|PREVIEW|PRUEBA|MUESTRA|EJEMPLO|VISTA\s+PREVIA|ARCHIVE|ARCHIVED|ARCHIVAD[OA]|BACKUP|RESPALDO)\]\s*/gi,
      '',
    )
    .replace(
      /^(?:TODO|FIXME|DRAFT|BORRADOR|WIP|TEST|DEMO|SAMPLE|STAGING|SANDBOX|PREVIEW|PRUEBA|MUESTRA|EJEMPLO|VISTA\s+PREVIA|ARCHIVE|ARCHIVED|ARCHIVAD[OA]|BACKUP|RESPALDO)\s*(?::|-|\u2013|\u2014)\s*/gi,
      '',
    )
    .replace(
      /\s*(?:[[(]\s*(?:TODO|FIXME|DRAFT|BORRADOR|WIP|TEST|DEMO|SAMPLE|STAGING|SANDBOX|PREVIEW|PRUEBA|MUESTRA|EJEMPLO|VISTA\s+PREVIA|ARCHIVE|ARCHIVED|ARCHIVAD[OA]|BACKUP|RESPALDO)\s*[\])]|\s*(?::|-|\u2013|\u2014)\s*(?:TODO|FIXME|DRAFT|BORRADOR|WIP|TEST|DEMO|SAMPLE|STAGING|SANDBOX|PREVIEW|PRUEBA|MUESTRA|EJEMPLO|VISTA\s+PREVIA|ARCHIVE|ARCHIVED|ARCHIVAD[OA]|BACKUP|RESPALDO))\s*$/gi,
      '',
    )
    .replace(firstRunListMarkerPattern, '')
