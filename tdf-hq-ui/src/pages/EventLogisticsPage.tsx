    ...
    >
      <Stack spacing={2.5} sx={{ '@media print': { '& .no-print': { display: 'none !important' }, '& .MuiCard-root': { breakInside: 'avoid', boxShadow: 'none' } } }}>
        ...
        {isOwner && <Card className="no-print" variant="outlined"><CardContent><Stack spacing={1.5}>
          ...
          >
            <Box sx={{ flex: 1 }}><UserSelector field={{ label: 'Persona del equipo', helperText: 'Busca por nombre o @username.' }} value={memberParty} onChange={setMemberParty} search={{ context: 'event_logistics', scopeId: eventId }} /></Box>
