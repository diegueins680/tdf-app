-- Require an explicit administrative exception flag before bypassing the
-- structured studio-audit completion gates. The original audit migration is
-- immutable; this forward migration carries the lifecycle hardening.
BEGIN;
